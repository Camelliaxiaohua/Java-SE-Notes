---
title: SpringIOC&DI（注解）
date: 2024-05-17 23:31:42
tags:
- Spring
categories:
- Spring
...
* 创建一个Maven项目
  ...
  ![1629860338328](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172325889.png)
...
![1629887733081](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172325268.png)
...
* 从mvn的仓库`https://mvnrepository.com/`中进行搜索
  ...
  ![1629888540286](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172325752.png)
...
![1629889170229](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172325522.png)
...
![1629903845404](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172325299.png)
...
![1629975492444](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172326982.png)
...
* 问题一:键值对的key为`username`引发的问题
  ...
  ![1629975934694](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172326801.png)
...
#### 1.2.3 加载properties文件小结
  ...
  * 如何开启`context`命名空间
    ...
    ![1629980280952](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172326508.png)
...
![1629982672522](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172326583.png)
...
![1629983245121](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172326703.png)
...
![1629985148294](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172326660.png)

(2)点击进入BeanFactory类，ctrl+h,就能查看到如下结构的层次关系

![1629984980781](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172327666.png)
...
![1629986510487](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172327119.png)
...
![1629986848563](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172327676.png)
...
![1629989221808](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172327960.png)
...
![1629990315619](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172327964.png)
...
![1630027590558](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172327840.png)
...
public class BookServiceImpl implements BookService {
    ...
    public void setBookDao(BookDao bookDao) { //不添加@Autowired注解会报错,但是为什么？
    ...
    ----------------------------------------------------------------------------
     /*public BookServiceImpl(BookDao bookDao) { 
        ...
        注意：为什么用这个不会报错？
        首先明确，这个bean的实例化用的是无参构造方法。
        在注入依赖时用的是构造方法注入，相当于xml文件中的：
        <bean id="bookDao" class="dao.BookDaoImpl" />
        这个在BookDaoImpl用注解声明为bean
        <bean id="bookService" class="service.impl.BookServiceImpl"> 
        这个在BookServiceImpl用注解声明为bean                                     
              <constructor-arg ref="bookDao" />
              这个就相当于构造方法
              但是后面的ref="BookDao"如何实现？
              就是构造方法的形参的类型和SpringIOC容器中的bean相匹配就注入。
              注意：这个在纯注解不适用，不加@Autowired（自动装配会报错）
        </bean>
    ---------------------------------------------------------------------------------
...
![1630027743910](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172328898.png)
...
![1630028345074](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172328072.png)
...
![1630029110506](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172328029.png)

至此，纯注解开发的方式就已经完成了，主要内容包括:

* Java类替换Spring核心配置文件

  ![1630029254372](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172328992.png)
...
![1630031112993](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172328683.png)

#### 3.3.2 Bean的作用范围

(1)先运行App类,在控制台打印两个一摸一样的地址，说明默认情况下bean是单例

![1630031192753](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172328464.png)
...
![1630031808947](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172328473.png)
...
![1630032385498](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172328110.png)
...
![1630033039358](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172328912.png)
...
![1630033604129](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172329431.png)

环境准备好后，运行后会发现有问题

![1630033710052](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172329094.png)
...
![1630034272959](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172329529.png)
...
* 先给两个Dao类分别起个名称
  ...
  * **@Autowired默认按照类型自动装配，如果IOC容器中同类的Bean找到多个，就==按照变量名和Bean的名称匹配==。因为变量名叫`bookDao`而容器中也有一个`booDao`，所以可以成功注入。**

  * 分析下面这种情况是否能完成注入呢?

    ![1630036236150](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172329413.png)
...
#### * 3.4.4  注解详解（字段注入、构造方法注入、Setter方法注入）
...
public class BookDaoImpl1 implements BookDao {
    ...
    @Override
    public void save() {
        System.out.println("Book Dao-《1》 save...");
    }
}
//BookDaoImpl2类
package dao.impl;
...
@Service("serviceBook1")
public class ServiceImpl1 implements ServiceBook {
    //1、使用字段注入
    @Autowired
    //@Qualifier("bookDao2")
    private BookDao bookDao;
    /**1、若只有一个BookDao实现类，则可以不用起别名（id）@Autowired会自己根据字段类型识别bean，然后注入
     * 2、若@Repository("bookDao")，@Repository("bookDao2")而字段是private BookDao bookDao;
     *    这时虽然有两个相同类型的bean，但他会选择字段和别名（id）相同的注入
     * 3、若@Repository("bookDao1")，@Repository("bookDao2")而字段private BookDao bookDao
     *    这时有两个相同类型的bean，所以会查找和字段相同的id注入，但是返现都不同这会报错。
     *    对于这种情况可以在@Autowired下用注解@Qualifier("bookDao2")这时会选择id=bookDao2的bean注入*/
    @Override
    public void save() {
        System.out.println("使用字段注入");
        bookDao.save();
    }
}
...
@Service("serviceBook2")
public class ServiceImpl2 implements ServiceBook {
    private BookDao bookDao;
    @Autowired
    public ServiceImpl2(@Qualifier("bookDao2") BookDao bookDao2) {
        this.bookDao = bookDao2;
    }

    /**1、若只有一个BookDao的实现类，可以用不起别名（id）
     *    @Autowired
     *    public ServiceImpl2(BookDao bookDao) {
     *         this.bookDao = bookDao;
     *     }
     * 2、若有多个相同类型的bean，@Repository("bookDao")、@Repository("bookDao1")。
     *    则会找和构造函数形参字段相同注入。
     *    @Autowired
     *     public ServiceImpl2(BookDao bookDao1) {
     *         this.bookDao = bookDao1;
     *     }
     *  3、若有多个相同的bean，@Repository("bookDao1")、@Repository("bookDao2")。
     *     若此时构造函数的形参是BookDao bookDao则会报错，因为按字段找不到相同的。
     *     此时要指定名称：
     *     @Autowired
     *     public ServiceImpl2(@Qualifier("bookDao2") BookDao bookDao2) {
     *         this.bookDao = bookDao2;
...
@Service("serviceBook3")
public class ServiceImpl3 implements ServiceBook {
    private BookDao bookDao;
    @Autowired
     ...
     *    则会找和构造函数形参字段相同注入。
     *    @Autowired
     *     public void setBookDao(BookDao1 bookDao1) {
     *         this.bookDao = bookDao1;
     *     }
     *  3、若有多个相同的bean，@Repository("bookDao1")、@Repository("bookDao2")。
     *     若此时Setter函数的形参是BookDao bookDao则会报错，因为按字段找不到相同的。
     *     此时要指定名称：
     *     @Autowired
     *     public void setBookDao(@Qualifier("bookDao2") BookDao bookDao) {
     *         this.bookDao = bookDao;
...
public class App {
    public static void main(String[] args) {
        AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(SpringConfig.class);
        ServiceBook service = ctx.getBean("serviceBook1",ServiceBook.class);
        service.save();
        service=ctx.getBean("serviceBook2",ServiceBook.class);
        service.save();
        service=ctx.getBean("serviceBook3", ServiceBook.class);
        service.save();
        ctx.close();
    }
}
...
![1630084683663](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172329822.png)
...
![1630122466404](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172329841.png)
...
![1630125475609](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172329787.png)
...
![1630134786448](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172329651.png)
...
//Serializable 是一个标记接口，用于指示类的对象可以被序列化。序列化是指将对象转换为字节流，以便可以在网络上传输或者存储到文件中，或者以其他方式在不同的 Java 虚拟机之间进行通信。被标记为 Serializable 的类的对象可以通过 Java 序列化机制进行序列化和反序列化。
```
...
![1630136904087](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172329691.png)
...
* Mybatis程序核心对象分析
  ...
  ![1630137189480](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172329155.png)

  从图中可以获取到，真正需要交给Spring管理的是==SqlSessionFactory==

* 整合Mybatis，就是将Mybatis用到的内容交给Spring管理，分析下配置文件

  ![1630137388717](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172330218.png)
...
* 使用SqlSessionFactoryBean封装SqlSessionFactory需要的环境信息
  ...
  ![1630138835057](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172330776.png)
...
* 使用MapperScannerConfigurer加载Dao接口，创建代理对象保存到IOC容器中
  ...
  ![1630138916939](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172330424.png)
...
![1630139036627](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172330397.png)
...
![1630139720273](https://camelliaxiaohua-1313958787.cos.ap-shanghai.myqcloud.com/asserts_JavaSE/202405172330872.png)
